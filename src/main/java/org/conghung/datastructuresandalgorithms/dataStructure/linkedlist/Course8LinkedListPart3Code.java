package org.conghung.datastructuresandalgorithms.dataStructure.linkedlist;

import java.util.Iterator;

public class Course8LinkedListPart3Code<T> implements DoublyLinkedList<T> {
    ...
    public boolean remove(Object object) {
        ...
        if (object == null) {
            ...
            while (currentNode != null) {
                if (object.equals(currentNode.getData())) {
                    remove(currentNode);
                    return true;
                }
                currentNode = currentNode.getNext();
    ...
    public static void main(String[] args) {
        DoublyLinkedList doublyLinkedList = new Course8LinkedListPart3Code();
        ...
        System.out.println(doublyLinkedList.removeAt(2));
