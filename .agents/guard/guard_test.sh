...
chk "AG write protected file"   '{"toolCall":{"name":"propose_code","args":{"TargetFile":"/repo/target/classes/Foo.class"}}}' 'protects /target/'
chk "AG write into target dir"  '{"toolCall":{"name":"write_to_file","args":{"AbsolutePath":"/repo/order-service/target/x.class"}}}' 'protects /target/'
